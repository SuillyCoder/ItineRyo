...
export default function BudgetManager({ 
  ...
  const [yenToPesoRate, setYenToPesoRate] = useState<number>(2.5);
  const [showRateModal, setShowRateModal] = useState(false);

  useEffect(() => {
    calculateBudget();
  }, [activities, selectedDay, shoppingCashAllowance]);
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
              <button
                ...
                className={`px-5 py-2.5 rounded-full font-medium whitespace-nowrap transition-all duration-200 ${
                  selectedDay === 'all'
                     ? 'bg-[#466149] text-white shadow-lg scale-105'
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-[#D5D0C0]">
          ...
          <div className="mb-4 flex justify-end">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-lg transition-all hover:shadow-lg bg-[#059669] text-white font-medium"
          ...
          <div id="budget-content">
            ...
            <div className="mb-6 bg-white bg-opacity-90 backdrop-blur-sm p-6 rounded-2xl border-2 border-[#10B981] border-opacity-30 shadow-lg">
              <div className="flex items-center gap-3 mb-4">
                <div className="bg-[#059669] bg-opacity-10 p-2 rounded-lg">
